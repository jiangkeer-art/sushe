    ...
    <el-container>
      ...
      <el-aside class="home_aside" width="200px">
        ...
        <el-menu router>
          ...
          <el-submenu index="1">
            <template slot="title"><i class="el-icon-s-platform"></i>单元楼宿管相关</template>
          ...
          <el-submenu index="2">
            <template slot="title"><i class="el-icon-user-solid"></i>学生相关</template>
          ...
          <el-submenu index="3">
            <template slot="title"><i class="el-icon-office-building"></i>宿舍楼相关</template>
          ...
          <el-submenu index="4">
            <template slot="title"><i class="el-icon-school"></i>宿舍相关</template>
...
.home_container {
  ...
  left: 0;
  width: 100%;
  background-image: url("../assets/253.png");
